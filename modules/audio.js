...
import {initShotSounds} from "./enemy.js";
...
export class Sound {
    ...
    static initSounds() {
        Sound.sounds = {
            ...
            eardeth: new SpatialSound("../audio/eardeth.wav", 10, 0.5),
            earhurt: new SpatialSound("../audio/eardeth.wav", 10, 0.5, 0.25),
            coreCannonBlast: new SpatialSound("../audio/core_cannon_blast.mp3", 5, 1),
            eShotTap: new SpatialSound("../audio/shot/tap.mp3", 20, 0.2),
