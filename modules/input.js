...
import {MainLoop, zoom, debugEnabled} from './main.js';
...
export const inputs = {
    up: new InputHandler(['w','arrowup']),
    down: new InputHandler(['s','arrowdown']),
    left: new InputHandler(['a','arrowleft']),
    right: new InputHandler(['d','arrowright']),
    ...
    loadOverride: new InputHandler(['p'])
}
